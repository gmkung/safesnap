...
import type {
  RealityEthV32Abi,
  RealityEthV32AbiInterface,
} from "../RealityEthV32Abi";
...
export class RealityEthV32Abi__factory {
  static readonly abi = _abi;
  static createInterface(): RealityEthV32AbiInterface {
    return new Interface(_abi) as RealityEthV32AbiInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): RealityEthV32Abi {
    return new Contract(address, _abi, runner) as unknown as RealityEthV32Abi;
  }
}
