...
import type {
  RealityEthV3Abi,
  RealityEthV3AbiInterface,
} from "../RealityEthV3Abi";
...
export class RealityEthV3Abi__factory {
  static readonly abi = _abi;
  static createInterface(): RealityEthV3AbiInterface {
    return new Interface(_abi) as RealityEthV3AbiInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): RealityEthV3Abi {
    return new Contract(address, _abi, runner) as unknown as RealityEthV3Abi;
  }
}
