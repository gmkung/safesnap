...
export interface RealityEthV32AbiInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface RealityEthV32Abi extends BaseContract {
  connect(runner?: ContractRunner | null): RealityEthV32Abi;
  waitForDeployment(): Promise<this>;

  interface: RealityEthV32AbiInterface;
