...
export default function Home() {
  ...
  return (
    <div className="p-4">
      ...
      {isLoading && (
        <Card className="mt-6 max-w-3xl mx-auto p-4 shadow-md bg-white">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Loading questions: {progress.processed} / {progress.total}</span>
