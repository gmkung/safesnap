    ...
    return (
        <div className="steel-panel h-full">
            ...
            <dl className="grid grid-cols-1 gap-4 p-4">
                ...
                {proposalData && proposalData.choices && proposalData.choices.length > 0 && (
                    <div>
                        <dt className="font-medium text-space-light/70">Proposal Choices</dt>
                        <dd className="mt-1 space-y-1">
                            {proposalData.choices.map((choice, index) => (
                                <div key={index} className="text-foreground flex items-center">
                ...
                {question.options && question.options.length > 0 && (
                    <div>
                        <dt className="font-medium text-space-light/70">Question Options</dt>
                        <dd className="mt-1 space-y-1">
